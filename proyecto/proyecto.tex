...
El oro presenta una volatilidad relativamente estable con episodios de variabilidad moderada. El modelo CEEMDAN-LSTM cae nuevamente en el problema de predicción del valor medio ya que con los parámetros que tiene no logra entender la dinámica de la serie, aun así en métricas supera al GARCH, obteniendo MAE de $4{,}48 \times 10^{-3}$ y RMSE de $5{,}63 \times 10^{-3}$ (reducción del 53{,}4\,\% en RMSE, $p$-valor DM $= 2{,}10 \times 10^{-12}$), pero su valor de uso es muy bajo. El GARCH sobreestima la variabilidad con MAE de $7{,}59 \times 10^{-3}$ y RMSE de $1{,}21 \times 10^{-2}$. El PSOQRNN obtiene la mejor precisión cuantitativa con MAE de $3{,}69 \times 10^{-4}$ y RMSE de $6{,}89 \times 10^{-4}$, lo que corresponde a una reducción del 94{,}3\,\% en RMSE respecto al GARCH ($p$-valor DM $= 1{,}93 \times 10^{-19}$, $p \ll 0.001$). El orden de desempeño es: PSOQRNN $>$ GARCH (Por deducción gráfica) $>$ CEEMDAN-LSTM.
